...
switch(true){
    //一星期執行一次、每個星期天執行
    case (date('w') == 0 && (date('H:i') == "08:06" || date('H:i') == "08:07" || date('H:i') == "08:08" || date('H:i') == "08:09" || date('H:i') == "00:04" || date('H:i') == "00:05")):
        //寄送當周工作檢核至管理員的email
    ...
    //每天00:00要執行的
    case (date('H:i') == "08:06" || date('H:i') == "08:07" || date('H:i') == "08:08" || date('H:i') == "08:09" || date('H:i') == "00:04" || date('H:i') == "00:05"):
        //清除昨天的值日生權限
