...
switch(true){
    ...
    case (date('w') == 0 && (date('H:i') == "08:45" || date('H:i') == "08:46" || date('H:i') == "08:47" || date('H:i') == "08:48" || date('H:i') == "00:04" || date('H:i') == "00:05")):
    ...
    //每天00:00要執行的
    case (date('H:i') == "08:45" || date('H:i') == "08:46" || date('H:i') == "08:47" || date('H:i') == "08:48" || date('H:i') == "00:04" || date('H:i') == "00:05"):
        //清除昨天的值日生權限
